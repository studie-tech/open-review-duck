...
export function AiSettings({
  ...
  const configuredProvider =
    ...
    (allowManagedModels ? "openai" : localDefaultAiPreset.provider);
  ...
  return (
    <PageContainer>
          ...
          {[
            {
              value: true,
              title: "Managed model",
              detail: "Workspace-provided model · usage limits may apply",
              icon: Sparkles,
            },
            {
              value: false,
              title: "Bring your own model",
              detail: "Your provider, model, endpoint, and encrypted API key",
              icon: KeyRound,
            },
      ...
      <section
        className={`bg-surface/70 grid gap-5 rounded-3xl border border-line p-6 ${allowManagedModels ? "mt-6" : "mt-9"}`}
      >
