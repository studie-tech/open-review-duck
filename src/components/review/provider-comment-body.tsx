...
export function ProviderCommentBody({
  body,
  className,
}: {
  body: string;
  ...
  return (
    ...
    >
      <ReactMarkdown
        ...
        rehypePlugins={[rehypeRaw, [rehypeSanitize, providerCommentSchema]]}
        components={{
          a: SafeProviderLink,
          blockquote: ({ children }) => (
          ...
          h1: ({ children }) => (
            <h1 className="text-cloud mt-4 mb-2 text-base font-semibold">
              {children}
            </h1>
          ),
          h2: ({ children }) => (
            <h2 className="text-cloud mt-4 mb-2 text-sm font-semibold">
              {children}
            </h2>
          ),
          h3: ({ children }) => (
            <h3 className="text-cloud mt-3 mb-1.5 text-xs font-semibold">
              {children}
            </h3>
          ),
